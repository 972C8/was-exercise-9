...
// Store witness ratings of rogue leader for the other agents
witness_ratings(
...
+!set_up_plans : true <- 
  ...
  // Rogue leader always broadcasts the same cold temperature.
  .add_plan({ +!read_temperature : true
    <-
      .print("Rogue leader brodcasts static cold temperature: ", -2);
